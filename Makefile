...
TARGETOBJS10=toplevel/$(TARGETNAME10)_main.cmo
...
toplevel/$(TARGETNAME10)_main.cmo: toplevel/$(TARGETNAME10)_main.ml
	$(OCAMLC) -thread $(OCAMLC_FLAGS) $(GALAX_ALL_INCLUDES) -c $<
...
toplevel/$(TARGETNAME10)_main.cmx: toplevel/$(TARGETNAME10)_main.ml
	$(OCAMLOPT) -thread $(OCAMLOPT_FLAGS) $(GALAX_ALL_INCLUDES) -c $<
